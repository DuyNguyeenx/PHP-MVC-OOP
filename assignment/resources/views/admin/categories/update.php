                ...
                <form method="post" action="/admin/category-update" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="id" value="<?= $category->id ?>">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" placeholder="Nhập vào tên danh mục" value="<?= $category->name ?>" />
                            <!-- <span class="form-text text-muted">We'll never share your email with anyone else.</span> -->
                        </div>
                    </div>
                    <div class="card-footer">
                        <button type="submit" class="btn btn-primary mr-2">Chỉnh sửa</button>
                        <a href="/admin/category" class="btn btn-default">Quay về</a>
                    </div>
                </form>
                <!--end::Form-->
            </div>

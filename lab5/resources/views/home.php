  ...
  <div class="container">
    ...
    <article>
      <div class="content">
        ...
        <div class="row">
          <?php foreach ($oderBy as $oder) : ?>
            <div class="col">
              <a href="#">
                <img src="images/<?php echo $oder->hinh ?>" alt="">
                <div class="product-name">
                  <h4><?php echo $oder->tenhh ?></h4>
                </div>
                <div class="price">
                <?php echo $oder->gia ?><u>đ</u>
                </div>
              </a>
              </div>
            <?php endforeach ?>
        ...
        <?php foreach ($tops as $top) : ?>
            <div class="col">
              <a href="#">
                <img src="images/<?php echo $top->hinh ?>" alt="">
                <div class="product-name">
                  <h4><?php echo $top->tenhh ?></h4>
                </div>
                <div class="price">
                <?php echo $top->gia ?><u>đ</u>
                </div>
              </a>
              </div>
            <?php endforeach ?>
